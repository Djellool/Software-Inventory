    ...
    <div class="col-md-10" >
        ...
        @endif
            ...
            <form  method="post" action="{{url('/UpApp/'.$app->id)}}" enctype="multipart/form-data" >
                ...
                <div class="form-row fform">
                    ...
                    <div class="form-group col-md-4">
                        <label for="liste" style="font-weight: bold;">Developpe en </label>
                        @if($app->interne == 0)
                            <input type="text" class="form-control formul" id="liste" value="Externe" readonly>
                        @else
                            <input type="text" id="liste" class="form-control formul" value="Interne" readonly>
                        @endif
                    ...
                    <div class="form-group col-md-4">
                        ...
                        @else
                            <label for="Editeur" style="font-weight: bold;">Developpee par</label>
                            <input type="text" class="form-control formu1" id="Editeur" value="{{$app->editeur}}" name="editeur" readonly>
                        @endif
                    </div>
                    <div class="form-group  col-md-4">
                    ...
                    <div class="form-group col-md-4">
                        <label for="architecture" style="font-weight: bold;">Architecture</label>
                        <input type="text" class="form-control formu1" id="arch" value="{{$app->Architecture}}"  name="architecture" readonly>
                    </div>
                    <div class="form-group col-md-4">
                ...
                <div class="form-row fform">
                    ...
                    <div class="form-group col-md-6">
                        <label for="structutilisatrice_id " style="font-weight: bold;">Structure utilisatrice</label>
                        <select id="structutilisatrice_id "  class="form-control" name="structutilisatrice_id" required>
                            <option value="{{$structutil->id}}">{{$structutil->nom}}</option>
                            @foreach($structures as $structure)
                                <option value="{{$structure->id}}">{{$structure->nom}}</option>
                            @endforeach
                        </select>
        ...
        <form  method="post" action="{{url('NewApp/'.$app->id)}}" enctype="multipart/form-data" >
            ...
            <div class="form-row fform">
                ...
                <div class="form-group  col-md-4">
                    <label for="DMP" style="font-weight: bold;">Date mise en place</label>
                    <input type="text" id="DMP" class="form-control formul" value="{{$app->DMP}}" name="DMP" readonly>
                </div>
                <div class="form-group col-md-4">
                    <label for="liste" style="font-weight: bold;">Developpe en </label>
                    @if($app->interne == 0)
                        <select id="liste"  class="form-control" name="interne" required>
                ...
                <div class="form-group col-md-4">
                    @if($app->interne == 0)
                        <label for="Editeur" style="font-weight: bold;">Editeur</label>
                        <input type="text" class="form-control formu1" id="Editeur" value="{{$app->editeur}}" name="editeur">
                    @else
                        <label for="Editeur" style="font-weight: bold;">Developpee par</label>
                        <input type="text" class="form-control formu1" id="Editeur" value="{{$app->editeur}}" name="editeur">
                    @endif
                ...
                <div class="form-group col-md-4">
                    <label for="architecture" style="font-weight: bold;">Architecture</label>
                    <input type="text" class="form-control formu1" id="arch" value="{{$app->Architecture}}"  name="architecture">
                </div>
                <div class="form-group col-md-4">
                    <label for="typeapp" style="font-weight: bold;">Type Application</label>
            ...
            <div class="form-row fform">
                ...
                <div class="form-group col-md-6">
                    <label for="structutilisatrice_id " style="font-weight: bold;">Structure utilisatrice</label>
                    <input type="text" class="form-control formu1" id="structutilisatrice_id"  name="structutilisatrice_id"  value="{{$structutil->nom}}" readonly>
                </div>
            ...
            <form  method="post" enctype="multipart/form-data" >
                ...
                <div class="form-row fform">
                    ...
                    <div class="form-group  col-md-4">
                        <label for="DMP" style="font-weight: bold;">Date mise en place</label>
                        <input type="text" id="DMP" class="form-control formul" value="{{$app->DMP}}" readonly>
                    </div>
                    <div class="form-group col-md-4">
                        <label for="liste" style="font-weight: bold;">Developpe en </label>
                        @if($app->interne == 0)
