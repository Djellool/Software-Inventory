...
<div class="container">
    <div class="col-md-12">
        ...
        <h3 style="margin-top: 3%;font-weight: bold;font-family: 'Segoe UI',sans-serif;padding-bottom:6px;border-bottom-style:solid;border-color:#5BC0DE;font-size: 30px;">{{$structname}}</h3><br>
        <div class="row">
            <div class="col-md-3">
                <a href="{{ url('/NewApp')}}" > <button style="position: relative;" class="btn btn-lg btn-info"><i class="fa fa-plus-square"></i> Nouvelle</button> </a>
            </div>
            <div class="col-md-2">
            </div>
            <div class="col-md-7">
