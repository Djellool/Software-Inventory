        ...
        <div class="col-md-12" >
            ...
            <form  method="post" action="{{url('/CreateNewApp/')}}" enctype="multipart/form-data" >
                ...
                <div class="form-row fform">
                    ...
                    <div class="form-group col-md-4">
                        <label for="Editeur" id="labelediteur" style="font-weight: bold;">Developpe par </label>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control formu1" id="arch"  name="architecture" required>
                    </div>
                    <div class="form-group col-md-4">
                        <label for="typeapp" style="font-weight: bold;">Type de l'application</label>
                        <select id="typeapp"  class="form-control" name="typeapp" required>
                            <option value="metier">Metier</option>
                            <option value="IT">Application IT</option>
                        </select>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#liste').change(function() {
            ...
            {
                $("#labelediteur").empty();
                $("#labelediteur").append("Developpe par");
            }else
            {
                $("#labelediteur").empty();
                $("#labelediteur").append("Editeur");
            }
        });
    });
</script>
